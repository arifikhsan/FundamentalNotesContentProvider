...
import com.example.fundamentalmynotesapp.db.DatabaseContract.NoteColumns.Companion.TABLE_NAME

internal class DatabaseHelper(context: Context) :
    SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {

    companion object {
        private const val DATABASE_NAME = "note_app_production"
        private const val DATABASE_VERSION = 1
        private const val SQL_CREATE_TABLE_NOTES = "CREATE TABLE $TABLE_NAME" +
